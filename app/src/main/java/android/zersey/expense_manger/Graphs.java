...
public class Graphs extends Fragment implements OnChartValueSelectedListener,OnChartGestureListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initPieChart();
            ...
            int Income_date, Total_Expense_PM = 0, Total_Income_PM = 0;
            Float Entertainment_Expense = 0f, Clothing_Expense = 0f, Food_Expense = 0f, Fuel_Expense = 0f, Health_expense = 0f;
            //cursor.moveToFirst();
        ...
        mChart.invalidate();
            float saving_amount = 0f, Amount2 = 0f;
